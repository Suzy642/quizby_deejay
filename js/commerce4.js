function answerA() {
  ...
  if (correct === 'wrong') {
    ...
    Accounting is a crucial aspect of commerce, involving the systematic process of recording, analyzing, and reporting financial transactions of a business or organization.`;
  }

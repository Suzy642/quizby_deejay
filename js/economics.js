...
function answerB() {
  ...
  if (correct === 'wrong') {
    ...
    Demand in economics refers to the quantity of a good or service that consumers are willing and able to purchase at various prices during a specific period.`;
  }

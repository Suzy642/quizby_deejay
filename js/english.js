function answerA() {
  ...
  if (correct === 'wrong') {
    ...
    document.querySelector('.js-correct-answer').innerHTML = `The correct answer is C because <br><br> A noun is a part of speech that identifies a person, place, thing, or idea.`;

...
function answerB() {
  ...
  if (correct === 'wrong') {
    ...
    document.querySelector('.js-correct-answer').innerHTML = `The correct answer is A because <br><br> Homophones are words that sound the same when pronounced but have different meanings and often different spellings. For example:"pair" and "pear"<br>"flour" and "flower"<br>"to," "too," and "two" etc... `;
  }

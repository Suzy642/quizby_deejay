function answerA() {
  ...
  if (correct === 'wrong') {
    ...
    document.querySelector('.js-correct-answer').innerHTML = `The correct answer is D because <br><br> 8 multiplying 8 is 64 not 16.`;
  }
...
function answerB() {
  ...
  if (correct === 'wrong') {
    ...
    document.querySelector('.js-correct-answer').innerHTML = `The correct answer is D because <br><br> 8 multiplying 8 is 64 not 60.`;
  }
...
function answerC() {
  ...
  if (correct === 'wrong') {
    ...
    document.querySelector('.js-correct-answer').innerHTML = `The correct answer is D because <br><br> 8 multiplying 8 is 64 not 65.`;
  }

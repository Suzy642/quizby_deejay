function answerA() {
  ...
  if (correct === 'wrong') {
    ...
    document.querySelector('.js-correct-answer').innerHTML = `The correct answer is B because <br><br> Square root of 25 is 5 not 0.`;
  }
...
function answerC() {
  ...
  if (correct === 'wrong') {
    ...
    document.querySelector('.js-correct-answer').innerHTML = `The correct answer is B because <br><br> Square root of 25 is 5 not 25.`;
  }
...
function answerD() {
  ...
  if (correct === 'wrong') {
    ...
    document.querySelector('.js-correct-answer').innerHTML = `The correct answer is B because <br><br> Square root of 25 is 5 not 15.`;
  }

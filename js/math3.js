...
function answerB() {
  ...
  if (correct === 'wrong') {
    ...
    Using bodmas (bracket order division multiplication addition substraction)
    <br><br>
    5x6(7-4)
    <br>first solve the bracket first using the law of bodmas
    <br> 7-4 = 3;
    <br>5x6 = 30;
    <br>30(3) which is 30x3 = 90.`;
  }

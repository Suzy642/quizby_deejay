...
function answerD() {
  ...
  if (correct === 'wrong') {
    ...
    document.querySelector('.js-correct-answer').innerHTML = `The correct answer is C because <br><br> A matrix is a rectangular array of numbers, symbols, or expressions arranged in rows and columns.`;
  }

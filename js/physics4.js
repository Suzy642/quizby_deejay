function answerA() {
  ...
  if (correct === 'wrong') {
    ...
    Density is a physical property of matter that measures how much mass is contained in a given volume. It is defined as the ratio of mass to volume and is mathematically expressed as:
      <br><br>
      Density = Mass ÷ Volume.`;
  }
